...
/**
 * 文件工厂
 * @author hc.L spring mvc 上传方式 controller 参数 MultipartFile类型 命名必须是 file
 */
public class FileUtils {
    ...
    public static FileInfo uploadFile(MultipartFile file, String depositUrl) {
        ...
        String id = UUID.randomUUID() + "" + System.currentTimeMillis();
     ...
     *
     * @param response
     * @param depositUrl 文件存放路径 (注:必须以“/”结尾)
     * @param fileName   文件名称
     */
     ...
     *
     * @param  writerUrl  isAdd 写入文件存放路径（文件不存在，自动新建）
     * @param isAdd     是否追加
     * @param txt       文本
     * @return boolean 写入成功
     */
